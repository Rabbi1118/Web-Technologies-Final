...
if(isset($_POST["btnRegister"]))
{
	...
	{
		$q="INSERT INTO instructor (Name,Email,Phone,Username,Password) VALUES('".$name."','".$useremail."','".$userphone."','".$uname."','".$userpass."')";
		$res=$con->query($q);
	}
}
?>
...
<html>
	<head>
		...
		<link rel="stylesheet" href="InstructorRegistration.css">
	</head>
	<body>
		<div class="container">
			<div class="upper">
